...
## Rate Limits
- **Unauthenticated**: 20 requests/min (IP-based)
- **Free (authenticated)**: 100 requests/min (User-based)
- **Pro (authenticated)**: 1000 requests/min (User-based)
